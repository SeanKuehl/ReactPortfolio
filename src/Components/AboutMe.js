  ...
  return (
    <div className="AboutMeDiv">
      ...
      <p className="AboutMeText">I'm a graduate of the <a href={linkToMyProgram}>Conestoga College Bachelors of Computer Science</a> and
        I have work experience in Web and Mobile development and I'm always looking for new things to explore. I love to tackle real problems with real impact and help everyone achieve their best.
        </p>
